...
export default function ProvinceForecasting() {
  ...
  const monthlyData = useMemo(() => {
    ...
    const provinceData =
      tourismData.predictions[selectedCountry]?.[selectedProvince];
  ...
  const countryTotal = useMemo(() => {
    ...
    return Object.values(countryData).reduce(
      (sum, province) => sum + province.total,
      0
    );
  }, [selectedCountry]);
  ...
  const analytics = useMemo(() => {
    if (!monthlyData.length)
      return { peakMonth: null, growthRate: 0, totalTourists: 0 };
    ...
    const growthRate = (
      ((lastMonth.tourists - firstMonth.tourists) / firstMonth.tourists) *
      100
    ).toFixed(1);
    const totalTourists = monthlyData.reduce(
      (sum, month) => sum + month.tourists,
      0
    );
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Predicted tourist arrivals in {selectedProvince} province,{" "}
                  {selectedCountry}
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="comparison" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Tourist distribution across provinces in {selectedCountry}
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Provinces ranked by total predicted tourist arrivals
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="seasonal" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Tourist arrivals by season in {selectedProvince},{" "}
                  {selectedCountry}
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Month-by-month tourist arrivals in {selectedProvince},{" "}
                  {selectedCountry}
                </CardDescription>
              </CardHeader>
              <CardContent>
